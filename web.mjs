...
(function ($) {
    ...
    class $bog_selection extends $mol_plugin {
        ...
        static listener() {
            ...
            return new $mol_dom_listener(doc, 'keydown', (event) => this.keydown(event), { passive: false });
        }
...
;
	($.$bog_selection_demo) = class $bog_selection_demo extends ($.$mol_page) {
		...
		Article(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.article()));
			(obj.plugins) = () => ([(this.Article_selection())]);
			return obj;
		}
		rows(){
			return [];
		...
		List(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.rows()));
			(obj.plugins) = () => ([(this.List_selection())]);
			return obj;
		}
		paste(next){
			if(next !== undefined) return next;
	...
	($mol_mem(($.$bog_selection_demo.prototype), "Article_selection"));
	($mol_mem(($.$bog_selection_demo.prototype), "Article"));
	($mol_mem(($.$bog_selection_demo.prototype), "List_selection"));
