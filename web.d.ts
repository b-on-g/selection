...
declare namespace $ {
	...
	>
	type $bog_selection__text_bog_selection_demo_2 = $mol_type_enforce<
		ReturnType< $bog_selection_demo['article'] >
		,
		ReturnType< $bog_selection['text'] >
	>
	type $mol_text__text_bog_selection_demo_3 = $mol_type_enforce<
		ReturnType< $bog_selection_demo['article'] >
		,
		ReturnType< $mol_text['text'] >
	>
	type $mol_text__plugins_bog_selection_demo_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_text['plugins'] >
	>
	type $bog_selection__text_bog_selection_demo_5 = $mol_type_enforce<
		ReturnType< $bog_selection_demo['list_text'] >
		,
		ReturnType< $bog_selection['text'] >
	>
	type $mol_list__rows_bog_selection_demo_6 = $mol_type_enforce<
		ReturnType< $bog_selection_demo['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_list__plugins_bog_selection_demo_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['plugins'] >
	>
	type $mol_textarea__hint_bog_selection_demo_8 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_bog_selection_demo_9 = $mol_type_enforce<
		ReturnType< $bog_selection_demo['paste'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_paragraph__title_bog_selection_demo_10 = $mol_type_enforce<
